...
Time to meet your new best friend: `get_involved_enzymes()` 👋
...
You've already met `get_involved_enzymes()` – perfect for getting the full cast of characters.
...
Ready for the grand finale? Meet `rebuild_biosynthesis()` –
