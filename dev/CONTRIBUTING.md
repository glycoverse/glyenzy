...
This outlines how to propose a change to glyenzy. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyenzy", fork = TRUE)`.
...
Please note that the glyenzy project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyenzy/dev/CODE_OF_CONDUCT.md).
