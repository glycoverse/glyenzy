...
* `trace_biosynthesis()` and `path_biosynthesis()` gain `method = "hybrid"` to
  annotate virtual biosynthesis transitions with exact rule-matched concrete
  enzyme candidates in the list-valued `concrete_enzymes` edge attribute.
