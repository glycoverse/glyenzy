...
* `trace_biosynthesis()` now infers `max_steps` from the largest target glycan when it is `NULL`, using its monosaccharide count plus 4 for N-glycans and minus 1 otherwise; explicit limits remain supported. (#40)
