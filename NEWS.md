...
* Built-in human enzyme rules now cover broader literature-supported acceptors with context-specific exclusions and requirements; Glc- or Gal-reducing structures without a represented carrier can be matched explicitly as free glycans or glycolipids.
...
* New `product_substrate_ratio()` calculates glycosyltransferase and
  ...
  for partial or reduced structures. (#44)
